%define name    tbdsbg-native
%define version 1.0.0
%define release %{_buildnumber}

Summary: The Betfair Destination Native SBG
Name: %{name}
Version: %{version}
Release: %{release}
Vendor: Betfair
...
%description
The Betfair Destination - Native SBG

%install
# Remove previous build_root if any
rm -rf %{buildroot}
# Create /var/app/tbdsbg-native folders on build_root and copy app files to it
