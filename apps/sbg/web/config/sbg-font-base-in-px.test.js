import { initSBGFontBaseinPx } from "./sbg-font-base-in-px";
...
describe("initSBGFontBaseinPx", () => {
  ...
  describe("when throttle is initially active", () => {
    ...
    it("should subscribe to store changes", () => {
      const unsubscribe = initSBGFontBaseinPx(mockStore);
  ...
  describe("edge cases", () => {
    it("should handle missing store state gracefully", () => {
      ...
      expect(() => initSBGFontBaseinPx(mockStore)).not.toThrow();
    });
