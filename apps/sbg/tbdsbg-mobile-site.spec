%define name    tbdsbg-mobile-site
%define version 1.0.0
%define release %{_buildnumber}

Summary: The Betfair Destination SBG
Name: %{name}
Version: %{version}
Release: %{release}
Vendor: Betfair
...
%description
The Betfair Destination SBG

%install
# Remove previous build_root if any
rm -rf %{buildroot}
# Create /var/app/tbdsgb-mobile-site folders on build_root and copy app files to it
