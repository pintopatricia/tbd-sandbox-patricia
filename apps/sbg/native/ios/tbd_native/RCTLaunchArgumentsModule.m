#import "RCTLaunchArgumentsModule.h"

@implementation RCTLaunchArgumentsModule

RCT_EXPORT_MODULE()

RCT_EXPORT_METHOD(getLaunchArguments:(RCTPromiseResolveBlock)resolve rejector:(RCTPromiseRejectBlock)reject)
{
  resolve([self argsToDictionary]);
}
