...
class AppDelegate: ExpoAppDelegate {
  ...
  private let shortcutModule = RCTShortcutModule()
  ...
  override func application(
    ...
    // Seeing if we have a shortcut within launch options, if we do we must return false
    shortcutModule.extractShortcut(fromLaunchOptions: launchOptions)
  ...
  override func application(_ application: UIApplication,
    ...
    shortcutModule.performAction(for: shortcutItem,
