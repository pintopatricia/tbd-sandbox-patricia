import { initPSFontBaseinPx } from "./ps-font-base-in-px";
...
describe("initPSFontBaseinPx", () => {
  ...
  describe("when throttle is initially active", () => {
    ...
    it("should subscribe to store changes", () => {
      const unsubscribe = initPSFontBaseinPx(mockStore);
  ...
  describe("edge cases", () => {
    it("should handle missing store state gracefully", () => {
      ...
      expect(() => initPSFontBaseinPx(mockStore)).not.toThrow();
    });
