...
ADD https://artifactory-prd.prd.betfair/artifactory/tbd-native/android/Betfair-${BUILD_NUMBER}.apk ./app/build/outputs/apk/play/inhouse/Betfair-${BUILD_NUMBER}.apk
