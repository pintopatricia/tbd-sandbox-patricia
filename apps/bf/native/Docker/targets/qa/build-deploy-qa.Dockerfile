FROM docker.app.betfair/ppb/tbdn/rn-android:2.0.0 AS build-qa
...
COPY --from=build-qa /usr/app/apps/bf/native/android/app/build/outputs/apk ./android/app/build/outputs/apk
...
COPY apps/bf/native/release_notes.txt ./fastlane
COPY apps/bf/native/android/Gemfile ./

COPY --from=build-qa /usr/app/apps/bf/native/android/app/build/outputs/apk/play/debug/app-play-debug.apk ./app/build/outputs/apk/play/debug/app-play-debug.apk
