...
import ConnectedPredicts from "@ppb/tbd-shared/components/Predicts";
import PredictsScreen from "@ppb/tbd-shared/components/Predicts/Predicts.native";
...
function PredictsRoute(): JSX.Element {
  return <ConnectedPredicts component={PredictsScreen} />;
}
...
function MainNavigator(): JSX.Element {
  return (
    ...
    >
      ...
      <MainStack.Screen
        name={ScreenName.PredictsScreen}
        component={PredictsRoute}
        options={{
          presentation: "modal",
          animation: "fade",
        }}
