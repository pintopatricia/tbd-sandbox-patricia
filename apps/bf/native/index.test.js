...
jest.mock("./App", () => "App");
jest.mock("./app.json", () => ({ name: "BetfairApp", brand: "betfair" }), { virtual: true });
...
describe("apps/bf/native/index.js", () => {
  ...
  it("registers the app runnable with the correct app name", () => {
    expect(AppRegistry.registerRunnable).toHaveBeenCalledWith("BetfairApp", expect.any(Function));
  });
