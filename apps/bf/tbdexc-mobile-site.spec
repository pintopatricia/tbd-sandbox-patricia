%define name    tbdexc-mobile-site
%define version 1.0.0
%define release %{_buildnumber}

Summary: The Betfair Destination
Name: %{name}
Version: %{version}
Release: %{release}
Vendor: Betfair
...
%description
The Betfair Destination

%install
# Remove previous build_root if any
rm -rf %{buildroot}
# Create /var/app/tbdexc-mobile-site folders on build_root and copy app files to it
