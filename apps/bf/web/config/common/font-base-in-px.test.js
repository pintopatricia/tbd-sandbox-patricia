import { initFontBaseinPx } from "./font-base-in-px";
...
describe("initFontBaseinPx", () => {
  ...
  describe("when throttle is initially active", () => {
    ...
    it("should subscribe to store changes", () => {
      const unsubscribe = initFontBaseinPx(mockStore);
  ...
  describe("edge cases", () => {
    it("should handle missing store state gracefully", () => {
      ...
      expect(() => initFontBaseinPx(mockStore)).not.toThrow();
    });
