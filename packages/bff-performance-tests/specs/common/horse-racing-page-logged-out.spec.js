...
describe("Horse racing page logged out", () => {
  let networkRecording;

  beforeAll(
    async function () {
      this.journeyName = "horse-racing-page-logged-out";
      networkRecording = this.networkRecording;
      await networkRecording.recordUrl("horse-racing/s-7?throttlesOff=PRELOAD_CATALOG");
