...
describe("Event page logged out", () => {
  ...
  beforeAll(
    async function () {
      ...
      this.journeyName = "football-event-page-logged-out";
      networkRecording = this.networkRecording;
      await networkRecording.recordUrl(`football/_/_/e-${eventData.eventId}?throttlesOff=PRELOAD_CATALOG`);
