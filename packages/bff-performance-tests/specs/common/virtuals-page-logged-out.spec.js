...
describe("Virtuals page logged out", () => {
  let networkRecording;

  beforeAll(
    async function () {
      this.journeyName = "virtuals-page-logged-out";
      networkRecording = this.networkRecording;
      await networkRecording.recordUrl("view/d-virtuals?throttlesOff=PRELOAD_CATALOG");
