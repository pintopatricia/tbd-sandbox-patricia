...
xdescribe("My Bets Open Page Logged in", () => {
  ...
  beforeAll(
    async function () {
      ...
      this.journeyName = "my-bets-open-page-logged-in";
      networkRecording = this.networkRecording;
      await networkRecording.recordUrl("mybets/open/mb-6f70656e?throttlesOff=PRELOAD_CATALOG");
