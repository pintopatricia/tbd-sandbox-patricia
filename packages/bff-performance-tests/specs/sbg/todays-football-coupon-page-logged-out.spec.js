...
describe("Todays football coupon page logged out", () => {
  let networkRecording;

  beforeAll(
    async function () {
      this.journeyName = "todays-football-coupon-page-logged-out";
      networkRecording = this.networkRecording;
      await networkRecording.recordUrl("odds/today/cpn-ZovAPBAAACMAiy1F%2Fs%2F1?d=Zl8eyhAAACEAl4Wb");
