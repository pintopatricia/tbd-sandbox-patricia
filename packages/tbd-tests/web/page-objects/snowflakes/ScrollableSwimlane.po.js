...
const {
  TEST_ID: MATCH_STAT_SELECTION_CARD,
...
const {
  ...
  TILE_GRADIENT: TEST_TILE_GRADIENT,
...
module.exports = class ScrollableSwimlanePO extends BasePO {
  ...
  /**
   * Gets the game tile list
   * @return {HTMLElement} a list of xmall game tiles gameTiles
   */
  get smallGameTiles() {
    return this.scrollSection.$$(TEST_TILE_GRADIENT);
  }
  ...
  /**
   * Gets the match stat selection card list
   * @return {HTMLElement[]} a list of match stat selection cards
   */
  get matchStatSelectionCards() {
    return this.element.$$(MATCH_STAT_SELECTION_CARD);
  }
