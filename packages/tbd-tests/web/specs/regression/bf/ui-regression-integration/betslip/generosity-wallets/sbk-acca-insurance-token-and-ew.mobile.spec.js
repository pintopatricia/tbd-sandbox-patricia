...
const eachWayOptionPO = new OptionPO(multipleControlsPO.eachway);
    ...
    describe("And clicks on the EW checkbox", () => {
      ...
      describe("And then selects and Acca Insurance Token through the Generosity Wallet", () => {
        beforeAll(async () => {
          ...
          await browser.waitUntil(
            () => browser.containsClass(multipleGenerosityWalletButtonPO.element, PromoButtonPO.states.selected),
            {
