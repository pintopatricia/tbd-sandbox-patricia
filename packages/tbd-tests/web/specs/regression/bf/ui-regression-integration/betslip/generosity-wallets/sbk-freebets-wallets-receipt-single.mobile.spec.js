...
const betSportsbookReceiptPO = new BetSportsbookReceiptPO();
const freeBetsWalletsAlertPO = new AlertPO(betSportsbookReceiptPO.element);
...
describe("SBK Free Bets Wallets - Single Receipt", () => {
  beforeAll(async () => {
    ...
    await browser.waitUntilDisplayed(betSportsbookReceiptPO.element);
  });

  it("[PRPI-7879] should display on receipt a generosity alert with 'Includes $5.00 in Free Bets' message without any action available", async () => {
