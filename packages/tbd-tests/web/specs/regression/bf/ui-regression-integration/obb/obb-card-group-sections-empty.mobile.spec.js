...
const OBB_SECTION_WITHOUT_LAYOUTS = {
  __typename: "ObbSection",
...
const OBB_SECTION_WITHOUT_CARDS = {
  __typename: "ObbSection",
...
const OBB_CARD_GROUP = {
  ...
  obbCardGroupSections: {
    edges: [
      {
        node: OBB_SECTION_WITH_CARDS,
      },
      {
        node: OBB_SECTION_WITHOUT_LAYOUTS,
      },
      {
        node: OBB_SECTION_WITHOUT_CARDS,
      },
    ],
  },
};
...
describe("OBB - Card Group - Sections - Empty", () => {
  beforeEach(async () => {
  ...
  describe("When a section has no cards", () => {
    it("[PRPI-6996] Then it should be discarded", async () => {
      expect(await obbCardGroupPO.sections.length).toBe(1);
