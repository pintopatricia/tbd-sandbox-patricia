const { ActionLinkPO, ObbBetButtonsCarouselPO } = require("../../../../../page-objects");
                                ...
                                edges: [
                                  {
                                    node: {
                                      ...
                                      showModalEntryPoint: false, //toggle inactive
...
describe("OBB - Squad Bet - Player Picker", () => {
  describe("Given I'm on an event page and I have a squadbet card with the toggle 'squad is editable' inactive", () => {
    beforeAll(async () => {
    ...
    it("[PRPI-5192]Then, the edit button in the card is not visible", async () => {
      expect(await editSquadLinkPO.element.isDisplayed()).toBeFalsy();
    });
  });
});
