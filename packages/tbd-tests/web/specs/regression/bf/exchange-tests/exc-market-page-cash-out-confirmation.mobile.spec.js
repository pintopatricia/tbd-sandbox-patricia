...
describe("Market Page - Cash Out - Confirmation", () => {
  beforeAll(async () => {
  ...
  describe("when the user clicks on the cash out button, with the confirmation preference ON", () => {
    beforeAll(async () => {
    ...
    it("[PRPI-5440] the cash out button should display the confirmation label and profit", async () => {
    ...
    describe("and after 5 seconds", () => {
      beforeAll(async () => {
        await browser.tickFakeClock("00:00:05");
      });
      ...
      it("[PRPI-5441] the cash out button should revert to the cash out label and profit", async () => {
    ...
    describe("and the quote is updated", () => {
      beforeAll(async () => {
        await mockService.mockHttpRequest(getQuote(CASHOUT_QUOTE_UPDATED_MOCK));
        await browser.tickFakeClock();
      });

      it("[PRPI-5442] the cash out button should display the updated label and profit", async () => {
