...
const MODULE_NAME = "gaming_swimlane";
...
describe("When user lands on gaming view with a gaming recommended games module", () => {
  beforeAll(async () => {
    ...
    await browser.waitUntilImageEquals(
      `${MODULE_NAME}_[PRPI-1348]_should_display_the_recommended_games_swimlane_with_first_and_second_game_tile`,
    );
  });

  it("[PRPI-1348]_should_display_the_recommended_games_swimlane_with_first_and_second_game_tile", async () => {
    expect(
  ...
  describe("Then the user scrolls until the fourth game", () => {
    ...
    it("[PRPI-1349]_should_display_the_third_and_the_fourth_game_tile", async () => {
      expect(
        await browser.checkScreen(`${MODULE_NAME}_[PRPI-1349]_should_display_the_third_and_the_fourth_game_tile`),
      ).toEqual(0);
    });
  });
});
