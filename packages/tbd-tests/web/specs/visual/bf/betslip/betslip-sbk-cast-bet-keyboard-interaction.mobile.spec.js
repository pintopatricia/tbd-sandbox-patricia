...
describe("SBK Keyboard Interactions - Cast Bet", () => {
  beforeAll(async () => {
    ...
    await browser.waitUntilImageEquals(
      `${MODULE_NAME}_[PRPI-1231]_should_render_sportsbook_betslip_cast_bet_with_keyboard_visible`,
    );
  });

  it("[PRPI-1231]_should_render_sportsbook_betslip_cast_bet_with_keyboard_visible", async () => {
    expect(
