...
describe("Multiples - Confirm Panel", () => {
  describe("when adding multiple selections to the Betslip", () => {
    beforeAll(async () => {
      ...
      await addStake(sportsbookStakeInputField, "0.12");
    });
    ...
    describe("and the user advances to confirm step", () => {
      beforeAll(async () => {
        ...
        await browser.waitUntilImageEquals(`${MODULE_NAME}_[PRPI-1244]_should_display_one_multiple_selection`);
      });

      it("[PRPI-1244]_should_display_one_multiple_selection", async () => {
        expect(await browser.checkScreen(`${MODULE_NAME}_[PRPI-1244]_should_display_one_multiple_selection`)).toBe(0);
      });
      ...
      describe("and one of the runners gets suspended", () => {
        beforeAll(async () => {
          ...
          await browser.waitUntilImageEquals(
            `${MODULE_NAME}_[PRPI-1245]_should_disable_confirm_button_and_show_market_availability_notification`,
          );
        });

        it("[PRPI-1245]_should_disable_confirm_button_and_show_market_availability_notification", async () => {
          expect(
