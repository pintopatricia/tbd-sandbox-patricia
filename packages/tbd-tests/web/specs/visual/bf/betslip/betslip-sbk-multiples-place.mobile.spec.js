...
describe("Multiples - Place Panel", () => {
  describe("when adding multiple selections to the Betslip", () => {
    beforeAll(async () => {
      ...
      await browser.waitUntilImageEquals(
        `${MODULE_NAME}_[PRPI-1256]_should_see_open_betslip_with_multiples_and_singles_sections_and_trash_icon_place_button_disabled`,
      );
    });

    it("[PRPI-1256]_should_see_open_betslip_with_multiples_and_singles_sections_and_trash_icon_place_button_disabled", async () => {
      expect(
