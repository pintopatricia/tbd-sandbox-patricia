...
describe("SBK Free Bets Wallets - Single Receipt", () => {
  beforeAll(async () => {
    ...
    await browser.waitUntilImageEquals(
      `${MODULE_NAME}_[PRPI-1360]_should_display_the_receipt_free_bets_wallets_generosity_alert`,
    );
  });

  it("[PRPI-1360]_should_display_the_receipt_free_bets_wallets_generosity_alert", async () => {
    expect(
