...
const singlesCardCollapsePO = new CardPO(sportsbookPlacePanelPO.collapsableSections[1]);
...
const singlesCardPO = new SinglesCardPO(singlesCardCollapsePO.element);
...
describe("SBK Free Bets Wallets - Bet Builder Receipt", () => {
  beforeAll(async () => {
    ...
    await browser.waitUntilDisplayed(betBuildersFreeBetsWalletsAlertPO.message);
    await browser.waitUntilImageEquals(
      `${MODULE_NAME}_[PRPI-1357]_should_display_the_bet_builder_receipt_free_bets_wallets_generosity_alert`,
    );
  });

  it("[PRPI-1357]_should_display_the_bet_builder_receipt_free_bets_wallets_generosity_alert", async () => {
    expect(
