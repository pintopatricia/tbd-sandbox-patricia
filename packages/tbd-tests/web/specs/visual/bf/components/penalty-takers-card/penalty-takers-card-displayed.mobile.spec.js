...
const { PenaltyTakersCardPO } = require("../../../../../page-objects");
...
const MODULE_NAME = "penalty_takers_card_displayed";
...
describe("Penalty Takers Card Available", () => {
  describe("Given I'm on an football event page", () => {
    ...
    describe("And the penalty market is set up", () => {
      beforeAll(async () => {
        await browser.waitUntilDisplayed(penaltyTakersCardPO.element);
        await browser.waitUntilImageEquals(`${MODULE_NAME}_[PRPI-11900]_then_the_penalty_takers_card_is_displayed`);
      });

      it("[PRPI-11900]_then_the_penalty_takers_card_is_displayed", async () => {
        expect(await browser.checkScreen(`${MODULE_NAME}_[PRPI-11900]_then_the_penalty_takers_card_is_displayed`)).toBe(
          0,
        );
      });
    });
