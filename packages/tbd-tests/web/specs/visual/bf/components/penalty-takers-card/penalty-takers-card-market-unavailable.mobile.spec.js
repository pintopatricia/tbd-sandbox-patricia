...
const MODULE_NAME = "penalty_takers_card_market_unavailable";
...
describe("Penalty Takers Card — market unavailable", () => {
  describe("Given I'm on an football event page", () => {
    describe("And the market becomes unavailable", () => {
      beforeAll(async () => {
        ...
        await browser.waitUntilImageEquals(`${MODULE_NAME}_[PRPI-11903]_then_the_betting_opportunity_is_blocked`);
      });

      it("[PRPI-11903]_then_the_betting_opportunity_is_blocked", async () => {
        expect(await browser.checkScreen(`${MODULE_NAME}_[PRPI-11903]_then_the_betting_opportunity_is_blocked`)).toBe(
          0,
        );
      });
    });
