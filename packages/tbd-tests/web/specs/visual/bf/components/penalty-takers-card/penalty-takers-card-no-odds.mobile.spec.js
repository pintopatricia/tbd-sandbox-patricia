...
const MODULE_NAME = "penalty_takers_card_no_odds";
...
describe("Penalty Takers Card — no odds", () => {
  describe("Given I'm on an football event page", () => {
    describe("And the market are without odds", () => {
      beforeAll(async () => {
        ...
        await browser.waitUntilImageEquals(`${MODULE_NAME}_[PRPI-11905]_then_the_betting_opportunity_is_blocked`);
      });

      it("[PRPI-11905]_then_the_betting_opportunity_is_blocked", async () => {
        expect(await browser.checkScreen(`${MODULE_NAME}_[PRPI-11905]_then_the_betting_opportunity_is_blocked`)).toBe(
          0,
        );
      });
    });
