...
describe("Freebets and acca insurance warning message", () => {
  beforeAll(async () => {
  ...
  describe("when user adds three selections", () => {
    ...
    describe("and the user clicks on the free bets checkbox", () => {
      ...
      describe("and the user clicks on ACCA Insurance checkbox", () => {
        beforeAll(async () => {
          await accaInsuranceOptionPO.element.waitForClickable();
          await accaInsuranceOptionPO.element.click();

          await browser.waitUntil(async () => accaInsuranceOptionPO.input.isSelected(), {
        ...
        it("[PRPI-4695]_should_see_the_free_bet_ineligible_message_when_acca_is_selected", async () => {
          expect(
            await browser.checkScreen(
              `${MODULE_NAME}_[PRPI-4695]_should_see_the_free_bet_ineligible_message_when_acca_is_selected`,
            ),
          ).toBe(0);
        });
      });
