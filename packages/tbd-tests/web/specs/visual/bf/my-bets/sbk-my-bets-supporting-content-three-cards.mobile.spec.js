    ...
    describe("and the stats, incidents events and live video are available for the event", () => {
      beforeAll(async () => {
        ...
        await browser.waitUntilImageEquals(
          `${MODULE_NAME}_[PRPI-1472]_should_be_displayed_the_Stats_Events_and_Live_Video_buttons_bellow_the_fixture_card`,
        );
      });

      it("[PRPI-1472]_should_be_displayed_the_Stats_Events_and_Live_Video_buttons_bellow_the_fixture_card", async () => {
        expect(
