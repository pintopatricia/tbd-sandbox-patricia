const { ObbPvpCardPO } = require("../../../../page-objects");
...
const MODULE_NAME = "obb_pvp_card";

describe("OBB - Pvp Card", () => {
  beforeAll(async () => {
    ...
    await browser.waitUntilImageEquals(`${MODULE_NAME}_[PRPI-1482]_should_render_card_correctly`);
  });

  it("[PRPI-1482]_should_render_card_correctly", async () => {
    expect(await browser.checkScreen(`${MODULE_NAME}_[PRPI-1482]_should_render_card_correctly`)).toBe(0);
  });
});
