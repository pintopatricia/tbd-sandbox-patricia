...
const MODULE_NAME = "obb_pvp_betslip_x_of_n_place_receipt";

describe("OBB - x of n - Place and receipt", () => {
  describe("when placing a x of n bet with success", () => {
    beforeAll(async () => {
    ...
    describe("and when I change the slider position", () => {
      beforeAll(async () => {
        ...
        await browser.waitUntilImageEquals(
          `${MODULE_NAME}_[PRPI-1480]_should_render_the_multiple_with_the_slider_on_the_2_of_3_position`,
        );
      });

      it("[PRPI-1480]_should_render_the_multiple_with_the_slider_on_the_2_of_3_position", async () => {
        expect(
    ...
    describe("and when I enter stake for the multiple", () => {
      ...
      it("[PRPI-1644] returns should be updated for the multiple bet", async () => {
      ...
      describe("and when I place the multiple bet", () => {
        beforeAll(async () => {
          ...
          await browser.waitUntilImageEquals(
            `${MODULE_NAME}_[PRPI-1481]_should_see_x_of_n_receipt_with_2_of_3_selections`,
          );
        });

        it("[PRPI-1481]_should_see_multiples_receipt", async () => {
          expect(
            await browser.checkScreen(`${MODULE_NAME}_[PRPI-1481]_should_see_x_of_n_receipt_with_2_of_3_selections`),
          ).toBe(0);
        });
      });
    });
