...
describe("Layout Entity - Race Results Card", () => {
  describe("When the user is on a given screen and 3 races are retrieved And the 1st race has no results", () => {
    ...
    describe("And the first race gets quick results", () => {
      ...
      it("[PRPI-3108] The 'Quick Result' label should be visible", async () => {
        expect(await racingResultsSO.title.getText()).toBe("Quick Results");
      });

      it("[PRPI-3109] The number of runners that ran: 'Ran: 5'", async () => {
        expect(await racingResultsSO.numberOfRanRunners.getText()).toBe("Ran: 5");
      });

      it("[PRPI-3110] The 3 first runners should be visible (pos 1,2,DNF)", async () => {
      ...
      it("[PRPI-3111] The 1st runner should be displayed", async () => {
        expect(await racingResultsSO.positions[0].getText()).toBe("1");
        ...
        expect(await racingResultsSO.startingPrices[0].getText()).toBe("3.6");
        expect(await racingResultsSO.favouriteLabels[0].getText()).toBe("Fav");
      });

      it("[PRPI-3112] The 1st runner silk should be displayed", async () => {
        expect(await racingResultsSO.silks[0].isDisplayed()).toBe(true);
      });

      it("[PRPI-3113] The 1st runner winner ribbon should be displayed", async () => {
        expect(await racingResultsSO.winnerRibbon.isDisplayed()).toBe(true);
      });

      it("[PRPI-3114] The 2nd runner should be visible with position '2'", async () => {
        expect(await racingResultsSO.positions[1].getText()).toBe("2");
      });

      it("[PRPI-3115] The 3rd runner should be visible with position 'DNF'", async () => {
        expect(await racingResultsSO.positions[2].getText()).toBe("DNF");
      });
    });
    ...
    describe("And the first race gets full results", () => {
      ...
      it("[PRPI-3116] The 'Full Results' label should be visible", async () => {
        expect(await racingResultsSO.title.getText()).toBe("Full Results");
      });

      it("[PRPI-3117] The number of runners that ran: 'Ran: 5'", async () => {
        expect(await racingResultsSO.numberOfRanRunners.getText()).toBe("Ran: 5");
      });

      it("[PRPI-3118] The 5 runners that ran should be visible (pos 1,2,DNF,PU,-)", async () => {
      ...
      it("[PRPI-3119] The 1st runner should be visible with position '1'", async () => {
        expect(await racingResultsSO.positions[0].getText()).toBe("1");
      });

      it("[PRPI-3120] The 2nd runner should be displayed", async () => {
        expect(await racingResultsSO.positions[1].getText()).toBe("2");
      ...
      it("[PRPI-3121] The 3rd runner should be visible with position 'DNF'", async () => {
        expect(await racingResultsSO.positions[2].getText()).toBe("DNF");
      });

      it("[PRPI-3122] The 4th runner should be visible with position 'PU'", async () => {
        expect(await racingResultsSO.positions[3].getText()).toBe("PU");
      });

      it("[PRPI-3123] The last runner should be displayed", async () => {
        expect(await racingResultsSO.positions[4].getText()).toBe("-");
      ...
      it("[PRPI-3124] The info section should be visible with 'DNF: did not finish' and 'PU: pull up' label", async () => {
      ...
      describe("When the user scrolls down", () => {
        ...
        it("[PRPI-3125] The title 'Winning Time & BSP Advantage' should be visible", async () => {
          expect(await raceResultsCardSO.winningTimeAndBspAdvantageLabel.getText()).toBe(
            "Winning Time & BSP Advantage",
          );
        });

        it("[PRPI-3126] The 'Winning Time' label and value should be visible", async () => {
        ...
        it("[PRPI-3127] The 'BSP Advantage' label and value should be visible '21%'", async () => {
    ...
    describe("When the user taps the 3rd race And the race has full results available And 1st and 2nd runners have performance info available", () => {
      ...
      it("[PRPI-3128] The 1st runner should be displayed", async () => {
        ...
        expect(await racingResultsSO.startingPrices[0].getText()).toBe("5.2");
        expect(await racingResultsSO.silks[0].isDisplayed()).toBe(true);
