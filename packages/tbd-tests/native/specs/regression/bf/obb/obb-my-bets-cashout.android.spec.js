...
describe("My Bets Page - OBB Cashout", () => {
  ...
  it("[PRPI-3717] should display the cashout button with the correct data", async () => {
  ...
  describe("[GRNFLDS-61] and when the FCQ quote becomes not eligible", () => {
    ...
    it("[PRPI-2807] should display the cashout button with the correct data", async () => {
  ...
  describe("When the user has an open bet with cashout available and clicks on the cashout button", () => {
    ...
    describe("[GRNFLDS-63] and the cashout is successfull", () => {
      beforeAll(async () => {
      ...
      it("[PRPI-3718] should display the cashout button with the correct data", async () => {
        expect(await primaryButtonSO.label.getText()).toBe("Cash Out Successful");
        expect(await primaryButtonSO.secondaryLabel.getText()).toBe("Profit");
        expect(await primaryButtonProfitSO.pnl.getText()).toBe("$0.00");
      });
    });
