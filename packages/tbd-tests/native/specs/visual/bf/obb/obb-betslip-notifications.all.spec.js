...
const placeBetButtonSO = new PrimaryButtonSO();
...
describe("OBB - Betslip Notifications", () => {
  describe("Given I'm on a OBB Card and I click on 'Add to betslip' button", () => {
    beforeAll(async () => {
    ...
    describe("And there's odds movement and I enter a stake higher than the available funds ", () => {
      beforeAll(async () => {
        legsQuotes.quotes.prices[0].price.decimal = 5;
        legsQuotes.quotes.prices[0].price.fractional.numerator = 5;
        legsQuotes.quotes.prices[0].price.fractional.denominator = 1;
        ...
        await stakeInputFieldSO.numberField.setValue("124");

        await browser.waitUntilEquals(placeBetButtonSO.label, "Deposit to Place $124.00 Bet");
        await browser.waitUntilImageEquals(
          `${MODULE_NAME}_[PRPI-4865]_betslip_should_display_the_two_correct_notifications`,
        );
      });

      it("[PRPI-4865]_betslip_should_display_the_two_correct_notifications", async () => {
        expect(
          (
