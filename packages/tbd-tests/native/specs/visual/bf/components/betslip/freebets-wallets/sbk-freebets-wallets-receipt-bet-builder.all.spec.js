...
describe("SBK Free Bets Wallets - Bet Builder Receipt", () => {
  beforeAll(async () => {
    ...
    // Opens double free bets wallets
    ...
    // Opens first single free bets wallets
    ...
    // Opens second single free bets wallets
    ...
    await browser.waitUntilImageEquals(
      `${MODULE_NAME}_[PRPI-4394]_should_display_the_bet_builder_receipt_free_bets_wallets_generosity_alert`,
    );
  });

  it("[PRPI-4394]_should_display_the_bet_builder_receipt_free_bets_wallets_generosity_alert", async () => {
    expect(
      (
