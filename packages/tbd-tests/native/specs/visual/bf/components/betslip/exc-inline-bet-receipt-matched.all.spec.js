  ...
  describe("when the user places a back bet and it gets matched", () => {
    beforeAll(async () => {
      ...
      await browser.waitUntilImageEquals(
        `${MODULE_NAME}_[PRPI-10438]_should_display_the_matched_receipt_after_placing_a_back_bet`,
      );
    });

    it("[PRPI-10438]_should_display_the_matched_receipt_after_placing_a_back_bet", async () => {
      expect(
        (
