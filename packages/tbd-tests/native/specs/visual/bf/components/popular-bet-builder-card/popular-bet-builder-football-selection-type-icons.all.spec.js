...
describe("PopularBetBuilder - Football Bet Builder with selection type icon", () => {
  describe("when the throttle POPULAR_BET_BUILDER_SELECTION_TYPE_ICON is active", () => {
    beforeAll(async () => {
      ...
      await browser.waitUntilImageEquals(
        `${CARD_NAME}_[PRPI-4927]_should_render_popular_bet_builder_card_with_selection_type_icon`,
      );
    });

    it("[PRPI-4927]_should_render_popular_bet_builder_card_with_selection_type_icon", async () => {
      expect(
        (
