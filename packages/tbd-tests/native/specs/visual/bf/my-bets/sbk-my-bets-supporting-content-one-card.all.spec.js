    ...
    describe("and only stats are available for the event", () => {
      beforeAll(async () => {
        ...
        await browser.waitUntilImageEquals(
          `${MODULE_NAME}_[PRPI-4499]_should_be_displayed_the_Stats_button_bellow_the_fixture_card`,
        );
      });

      it("[PRPI-4499]_should_be_displayed_the_Stats_button_bellow_the_fixture_card", async () => {
        expect(
          (
