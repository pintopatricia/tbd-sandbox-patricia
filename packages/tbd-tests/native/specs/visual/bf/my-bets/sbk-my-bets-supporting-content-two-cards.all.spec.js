...
describe("My Bets Page (Open Bets) - Supporting Content", () => {
  describe("When the user has a Football open bet", () => {
    describe("and the stats and incidents events are available for the event", () => {
      beforeAll(async () => {
        ...
        await browser.waitUntilImageEquals(
          `${MODULE_NAME}_[PRPI-4501]_should_be_displayed_the_Stats_and_Events_buttons_bellow_the_fixture_card`,
        );
      });

      it("[PRPI-4501]_should_be_displayed_the_Stats_and_Events_buttons_bellow_the_fixture_card", async () => {
        expect(
          (
