import normalizer from "./future-racing-card-group-normalizer";
    ...
    edges: [
      {
        ...
        node: {
          ...
          urn: "ppb:tbd:card:quickLinks:futureRacing:event1|1;2",
        },
      },
    ],
  },
  partials: {
    edges: [
      ...
      },
      {
        ...
        node: {
          __typename: "QuickLinksCard",
          urn: "ppb:tbd:card:quickLinks:futureRacing:event2|1;2",
        },
      },
      {
        date: "1234T",
        node: {
          __typename: "QuickLinksCard",
          urn: "ppb:tbd:card:quickLinks:futureRacing:event3|1;2",
        },
      },
    ],
    pageInfo: {
...
describe("Future racing card group normalizer", () => {
