...
import { TEST_ID as BASKETBALL_FIXTURE } from "./BasketballFixture.web.selectors";
import BasketballFixture from "./BasketballFixture.web";
...
jest.mock("./BasketballFixture.helper", () => ({
  ...
  isBasketballFixtureEqual: jest.fn(() => false),
}));
...
describe("BasketballFixture", () => {
  ...
  it("must render with a basketball fixture component and scoreboard", () => {
    component = renderBasketballFixture(basketballFixtureProps).container;

    expect(component.querySelector(BASKETBALL_FIXTURE)).toBeVisible();
  });

  it("must render a basketball fixture component and scoreboard with current score when viewMode is COUPON", () => {
    const COUPON_VIEW_MODE = "COUPON";

    renderBasketballFixture({ ...basketballFixtureProps, viewMode: COUPON_VIEW_MODE });

    expect(BasketballFixtureComponent).toHaveBeenCalledWith(
  ...
  it("must render a basketball fixture component and scoreboard with current score when viewMode is COUPON and liveVideo is false", () => {
    const COUPON_VIEW_MODE = "COUPON";

    renderBasketballFixture({ ...basketballFixtureProps, viewMode: COUPON_VIEW_MODE, videoAvailable: false });
  ...
  it("must render a basketball fixture component and scoreboard with default view mode when no view mode is passed as prop", () => {
    component = renderBasketballFixture({
  ...
  it("must render a basketball fixture component and scoreboard with correct view mode when passed", () => {
    const CUSTOM_VIEW_MODE = "CUSTOM_VIEW_MODE";
    renderBasketballFixture({ ...basketballFixtureProps, viewMode: CUSTOM_VIEW_MODE });
