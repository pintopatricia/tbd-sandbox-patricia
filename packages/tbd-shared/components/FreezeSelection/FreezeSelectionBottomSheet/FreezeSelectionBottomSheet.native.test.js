...
import { Drawer, Alert } from "@ppb/the-wall-native";
...
import FreezeSelectionBottomSheet from "./FreezeSelectionBottomSheet.native";
...
jest.mock("../FreezeConfirmButton/FreezeConfirmButton.native", () => ({
  FreezeConfirmButton: jest.fn((props) => <freeze-confirm-button-mock {...props}></freeze-confirm-button-mock>),
}));

jest.mock("../../Card/snowflakes/FreezeCard/FreezeCard.native", () => ({
...
jest.mock("../../EventHeaderCard/EventHeaderCard.native", () => ({
...
describe("FreezeSelectionBottomSheet Component", () => {
  ...
  it("should call onDismiss when Drawer.onOutsideTap is called", () => {
    renderFreezeSelectionBottomSheet(aProps());
