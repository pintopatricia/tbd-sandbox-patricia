...
import { memo, FunctionComponent, useCallback, useEffect, useMemo } from "react";
import { View } from "react-native";

import type { ExchangeSide } from "@ppb/tbd-store/state/betting/exchange-bets/ExchangeBet.types";
import URN from "@ppb/tbd-store/state/layout/URN";
import { type BetButtonSize, BetButtonStatus } from "./snowflakes/BetButton/BetButton.types";
import { ExchangeBetButton } from "./snowflakes/ExchangeBetButton/ExchangeBetButton.native";
import { ComponentProps } from "./props";
import styles from "./ExchangeBetButtons.native.styles";
...
const RenderButtonMemo: FunctionComponent<ExchangeBetButtonsRenderButtonProps> = memo(
  ({
    ...
    const containerStyle = useMemo(
      () => [styles.button, styles.overflownHidden, index !== 0 && styles.buttonMargin],
      [index],
    );
