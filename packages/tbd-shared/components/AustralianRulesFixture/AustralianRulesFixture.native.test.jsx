...
import AustralianRulesFixture from "./AustralianRulesFixture.native";
import { getStatusLabel } from "./AustralianRulesFixture.helper";
...
jest.mock("@ppb/the-wall-icons", () => ({
  SportsIconName: { AUSSIE_FOOTBALL: "AustralianRulesIcon" },
...
describe("australianRulesFixture", () => {
  ...
  describe("when viewMode is COUPON", () => {
    beforeEach(() => {
      container = renderAustralianRulesFixture({
    ...
    it("should call AvBScoreboard with correct arguments", () => {
      expect(AvBScoreboard).toHaveBeenCalledWith(
        expect.objectContaining({
          ...
          showEventDateBelow: australianRulesFixtureProps.showEventDateBelow,
          showHorizontalDuration: australianRulesFixtureProps.showHorizontalDuration,
        }),
        undefined,
      );
    });
  ...
  describe("when icon is undefined", () => {
    beforeEach(() => {
      container = renderAustralianRulesFixture({ ...australianRulesFixtureProps, icon: undefined });
    });
