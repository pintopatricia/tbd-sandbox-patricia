...
import ObbOnboardingCardsCardGroupPlaceholder from "./ObbOnboardingCardsCardGroupPlaceholder.web";
...
jest.mock("../../ObbOnboardingCard/placeholder/ObbOnboardingCardPlaceholder.web", () =>
...
const renderComponent = (isDesktopLayout = false) =>
  render(
    <ConfigContext.Provider value={{ isDesktopLayout }}>
      <ObbOnboardingCardsCardGroupPlaceholder />
    </ConfigContext.Provider>,
  );

describe("ObbOnboardingCardsCardGroupPlaceholder - Web", () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
  ...
  describe("when component renders", () => {
    ...
    it("should render 3 inner card placeholders", () => {
      renderComponent();

      expect(ObbOnboardingCardPlaceholder).toHaveBeenCalledTimes(3);
    });
  });
});
