...
import StatsSupportingContentButtonsCardGroup from "./StatsSupportingContentButtonsCardGroup.native";
...
jest.mock("../snowflakes/SupportingContentCardGroup/SupportingContentCardGroup.native", () =>
...
const mockUseStatsSupportingContentButtonsCardGroupVM = {
  vm: {
    data: {
...
jest.mock("../viewmodel/StatsSupportingContentButtonsCardGroup.viewmodel", () => ({
  ...
  __esModule: true,
  default: jest.fn(() => mockUseStatsSupportingContentButtonsCardGroupVM),
}));
