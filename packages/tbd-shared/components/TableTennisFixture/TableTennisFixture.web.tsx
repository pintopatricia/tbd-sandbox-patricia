...
import { AvBFixture as TableTennisComponent, AvBScoreboard } from "@ppb/the-wall-web";
...
import styles from "./TableTennisFixture.web.css";
...
const TableTennisFixture: FunctionComponent<ComponentProps> = ({
  ...
  return (
    <div className={styles.tableTennisFixture}>
