...
import ExtraWalletCardGroup from "./ExtraWalletCardGroup.web";
...
describe("ExtraWalletCardGroup", () => {
  ...
  it("should call the Option and Divider with the correct props and the Connected Cards listed in items", () => {
    render(
  ...
  it("should dispatch the right functions when user clicks on alert", () => {
    ...
    expect(mockDispatchPushExternalBlankAction).toHaveBeenCalledWith(mockHelpUrl);
  });
  ...
  it("should call scrollIntoView on ExtraWalletCardGroup when currentPeble is changed", () => {
