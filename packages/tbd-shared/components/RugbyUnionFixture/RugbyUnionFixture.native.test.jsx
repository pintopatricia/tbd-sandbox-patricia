...
import RugbyUnionFixture from "./RugbyUnionFixture.native";
...
jest.mock("@ppb/the-wall-icons", () => ({
  SportsIconName: { RUGBY_UNION: "RugbyUnionIcon" },
...
describe("RugbyUnionFixture", () => {
  ...
  describe("when viewMode is COUPON", () => {
    beforeEach(() => {
      container = renderRugbyUnionFixture({
    ...
    it("should call AvBScoreboard with correct arguments", () => {
      expect(AvBScoreboard).toHaveBeenCalledWith(
        expect.objectContaining({
          ...
          showEventDateBelow: rugbyUnionFixtureProps.showEventDateBelow,
          showHorizontalDuration: rugbyUnionFixtureProps.showHorizontalDuration,
        }),
        undefined,
      );
    });
  ...
  describe("when icon is undefined", () => {
    beforeEach(() => {
      container = renderRugbyUnionFixture({ ...rugbyUnionFixtureProps, icon: undefined });
    });
