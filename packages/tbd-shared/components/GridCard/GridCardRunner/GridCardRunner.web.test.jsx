...
import GridCardRunner from "./GridCardRunner.web";
import FootballRunner from "../../FootballRunner/FootballRunner.web";

jest.mock("../RunnerListHeader/RunnerListHeader.web", () => jest.fn(() => <runner-list-header-mock />));
jest.mock("@ppb/the-wall-web", () => ({ Runner: jest.fn(() => <runner-mock />) }));
jest.mock("../GridCardItem/GridCardItem.web", () => jest.fn(() => <connected-grid-card-item />));
jest.mock("../GridCardItem", () => jest.fn(() => <grid-card-item-mock />));
jest.mock("../../FootballRunner/FootballRunner.web", () => jest.fn(() => <football-runner-mock />));
