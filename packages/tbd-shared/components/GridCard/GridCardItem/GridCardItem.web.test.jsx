...
import GridCardItem from "./GridCardItem.web";
...
describe("GridCardItem", () => {
  ...
  it("should subscribe poller updates when intercepting", () => {
    ...
    renderGridCardItem({ dispatchSportsbookMarketUpdatesSubscribe: mock, isIntersecting: true });
  ...
  it("should unsubscribe poller updates when not intercepting", () => {
    ...
    renderGridCardItem({ dispatchSportsbookMarketUpdatesUnsubscribe: mock, isIntersecting: false });
