...
describe("makeMapStateToProps", () => {
  ...
  describe("runnerUrn", () => {
    it("should return the runner urn", () => {
      ...
      expect(props.runnerUrn).toEqual("R:1");
    });
  });
  ...
  describe("is90Min", () => {
    describe("when the market type is 90 min", () => {
      it("should return is90Min", () => {
        const props = setupMapStateToProps({
          ownProps: { id: "C:1" },
          metadata: {
            "R:1": {
        ...
        expect(props.is90Min).toEqual(true);
      });
    });

    describe("when the market type is not 90 min", () => {
      it("should not return is90Min", () => {
        const props = setupMapStateToProps({
          ownProps: { id: "C:1" },
          metadata: {
            "R:1": {
        ...
        expect(props.is90Min).toEqual(false);
      });
    });
  });
  ...
  describe("isPriceBoosted", () => {
    describe("when market is odds boost type", () => {
      it("should return true", () => {
        const props = setupMapStateToProps({
          ownProps: { id: "C:1" },
          metadata: { "R:1": { isOddsboostMarketType: true } },
        });

        expect(props.isPriceBoosted).toBe(true);
      });
    });

    describe("when none of the above", () => {
      it("should return false", () => {
        const props = setupMapStateToProps({
          ownProps: { id: "C:1" },
          metadata: { "R:1": { isOddsboostMarketType: false } },
          bettingState: { combinations: { "C:1": { isPriceBoostSelected: false, legs: ["LEG:1"] } } },
        });

        expect(props.isPriceBoosted).toBe(false);
      });
    });
  });
  describe("boostedInfo", () => {
    it("should return undefined when isPriceBoosted is false", () => {
      const props = setupMapStateToProps({
        ownProps: { id: "C:1" },
        metadata: { "R:1": { isOddsboostMarketType: false } },
        bettingState: { combinations: { "C:1": { isPriceBoostSelected: false, legs: ["LEG:1"] } } },
      ...
      expect(props.boostedInfo).toBeUndefined();
    });
    it("should return correct icon and label when isPriceBoosted is true", () => {
      const props = setupMapStateToProps({
        ownProps: { id: "C:1" },
        metadata: { "R:1": { isOddsboostMarketType: true } },
        bettingState: { combinations: { "C:1": { isPriceBoostSelected: true, legs: ["LEG:1"] } } },
      });

      expect(props.boostedInfo).toEqual({
        iconName: "Value--Price-Boost",
  ...
  describe("hasBoostSignposting", () => {
    describe("when PRICE_BOOST_SINGLES_SIGNPOSTING is enabled", () => {
      it("should return true", () => {
        createGetThrottleSelector.mockReturnValue(jest.fn(() => ({ isActive: true })));
        ...
        expect(props.hasBoostSignposting).toBe(true);
      });
    });

    describe("when PRICE_BOOST_SINGLES_SIGNPOSTING is disabled", () => {
      it("should return true", () => {
        createGetThrottleSelector.mockReturnValue(jest.fn(() => ({ isActive: false })));
        ...
        expect(props.hasBoostSignposting).toBe(false);
      });
    });

    describe("when PRICE_BOOST_SINGLES_SIGNPOSTING does not exist", () => {
      it("should return false", () => {
        createGetThrottleSelector.mockReturnValue(jest.fn());
  ...
  describe("title", () => {
    it("should return output of buildSelection name", () => {
      const props = setupMapStateToProps({
        selection: { name: "Name" },
        preferences: {
      ...
      expect(props.title).toEqual("Name");
    });

    it("should call buildSelection with metadata and bettingRunner", () => {
      setupMapStateToProps({
      ...
      expect(buildSelection).toHaveBeenCalledWith({ previousOdds: [1.23] }, {}, "bettingRunner");
    });
  });

  describe("handicap", () => {
    it("should return output of buildSelection handicap", () => {
      const props = setupMapStateToProps({
      ...
      expect(props.handicap).toEqual("+1");
    });
  });
  ...
  describe("silkIcon", () => {
    it("should return output of buildSelection", () => {
      ...
      expect(props.icon).toEqual("silkIcon");
    });
  });

  describe("racingSport", () => {
    it("should return output of buildSelection", () => {
      const props = setupMapStateToProps({
        selection: { racingSport: 7 },
        preferences: {
          sportsbookOddsDisplay: "fractional",
        },
        ownProps: { id: "C:1" },
      ...
      expect(props.racingSport).toEqual(7);
    });
  });

  describe("silkFallbackIconType", () => {
    it("should return output of buildSelection", () => {
      const props = setupMapStateToProps({
        selection: { silkFallbackType: "silkFallbackIconType" },
        preferences: {
          sportsbookOddsDisplay: "fractional",
        },
        ownProps: { id: "C:1" },
      ...
      expect(props.silkFallbackIconType).toEqual("silkFallbackIconType");
    });
  });

  describe("meetingCountry", () => {
    it("should return output of buildSelection", () => {
      const props = setupMapStateToProps({
        selection: { meetingCountry: "UK" },
        preferences: {
          sportsbookOddsDisplay: "fractional",
        },
        ownProps: { id: "C:1" },
      ...
      expect(props.meetingCountry).toEqual("UK");
    });
  });

  describe("isGuaranteedPriceSelected", () => {
    it("should return isGuaranteedPriceSelected of combination", () => {
      const props = setupMapStateToProps({
        bettingState: {
          combinations: {
            "C:1": { id: "C:1", legs: ["LEG:1"], isGuaranteedPriceSelected: true },
          },
        },
        preferences: {
          sportsbookOddsDisplay: "fractional",
      ...
      expect(props.isGuaranteedPriceSelected).toEqual(true);
    });
  });

  describe("guaranteedPriceLabel", () => {
    it("should return correct label", () => {
      const props = setupMapStateToProps({
        bettingState: {
          combinations: {
            "C:1": { id: "C:1", legs: ["LEG:1"] },
          },
        },
        preferences: {
          sportsbookOddsDisplay: "fractional",
      ...
      expect(props.guaranteedPriceLabel).toEqual("I18N.LABELS.BEST_ODDS_GUARANTEED_REDUCED");
    });
  });
  ...
  describe("mapDispatchToProps", () => {
    ...
    describe("dispatchRemoveSelectionAction", () => {
      it("should call dispatch twice", () => {
        ...
        dispatchRemoveSelectionAction({ legId: "id:1" });
