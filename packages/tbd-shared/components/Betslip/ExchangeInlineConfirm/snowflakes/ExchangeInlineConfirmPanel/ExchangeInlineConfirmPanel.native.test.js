...
import { ExchangeInlineConfirmPanel } from "./ExchangeInlineConfirmPanel.native";
  ...
  describe("InlinePanel", () => {
    ...
    describe("SecondaryButton", () => {
      it("should be called with expected values", () => {
        ...
        expect(SecondaryButton).toHaveBeenCalledWith({ label: "editMock", onTap: onEditMock }, undefined);
