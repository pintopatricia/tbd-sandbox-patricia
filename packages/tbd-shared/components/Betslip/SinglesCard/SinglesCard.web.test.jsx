...
import { SinglesCard } from "./SinglesCard.web";
...
jest.mock("../Single/Single.web", () => jest.fn(({ props }) => <single-mock {...props} />));

jest.mock("../OneLineBet", () => jest.fn(({ props }) => <connected-one-line-bet-mock {...props} />));
jest.mock("../OneLineBet/OneLineBet.web", () => jest.fn(({ props }) => <one-line-bet-mock {...props} />));
