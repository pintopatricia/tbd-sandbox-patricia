...
import MarketBetSelectionCard from "./MarketBetSelectionCard.web";
...
jest.mock("../BetInfoCollapse/BetInfoCollapse.web", () => ({
...
const defaultProps = {
  ...
  viewLink: {
    viewUrn: "market-view-urn-mock",
    viewUrl: "market-view-url-mock",
  },
...
describe("Market Bet Selection Card web component", () => {
  ...
  describe("when props statusLabelText and statusLabelType doesn't exists", () => {
    it("should not render ConnectedCashout component", () => {
      const { container } = renderMarketBetSelectionCard({
        ...defaultProps,
        statusLabelText: undefined,
        statusLabelType: undefined,
      });

      expect(container.getElementsByClassName(styles.betSelectionDetailsContainer)[0]).toBeUndefined();
    });
  });
