...
import { Card, HorseRacingRunner, Divider, StatusLabel } from "@ppb/the-wall-native";
import StatsRaceResultsCard from "./StatsRaceResultsCard.native";
...
jest.mock("../../StatsContentCardPlaceholder/StatsContentCardPlaceholder.native", () =>
  jest.fn(() => (
    <stats-content-card-placeholder testID="stats-content-card-placeholder">
  ...
  describe("when data is loaded", () => {
    describe("and data doesn't exist", () => {
      it("should render null", () => {
        const { toJSON } = renderComponent(null, false);
