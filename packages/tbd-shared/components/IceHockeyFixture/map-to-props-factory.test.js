...
jest.mock("@ppb/tbd-store/state/entities/ice-hockey-fixture/ice-hockey-fixture-selectors", () => ({
  createIceHockeyFixtureByURNSelector: jest.fn(),
}));
...
const FORMAT_SCOREBOARD_DATA = [
  ...
  { teamA: 3, teamB: 1, style: "FINISHED" },
  { teamA: 2, teamB: 2, style: "FINISHED" },
...
const APPLICATION_STATE = {
  entities: {
    icehockeyfixtures: ICE_HOCKEY_FIXTURE,
    competitions: {},
    sportevents: {},
  },
};
...
const setupMapStateToProps = (state, props) => {
  ...
  createIceHockeyFixtureByURNSelector.mockReturnValue(getIceHockeyFixtureByURN);
  ...
  getIceHockeyFixtureByURN.mockReturnValue(ICE_HOCKEY_FIXTURE);
...
describe("MapToPropsFactory - IceHockeyFixture", () => {
  ...
  it("should create a selector for IceHockey fixture", () => {
    makeMapStateToProps();

    expect(createIceHockeyFixtureByURNSelector).toHaveBeenCalledWith();
    expect(createIceHockeyFixtureByURNSelector).toHaveBeenCalledTimes(1);
  });
  ...
  describe("mapStateToProps", () => {
    describe("when IceHockey fixture exists on the store", () => {
      describe("when there is a sportEventURN", () => {
        it("should return props with competition", () => {
          ...
          expect(getIceHockeyFixtureByURN).toHaveBeenCalledWith(ICE_HOCKEY_FIXTURE, URN);
      ...
      describe("and opponent names are provided", () => {
        it("should return props with competition", () => {
          getIceHockeyFixtureByURN.mockReturnValueOnce({
            ...ICE_HOCKEY_FIXTURE,
            opponentsNames: {
              teamA: "teamA name",
              teamB: "teamB name",
    ...
    describe("when IceHockey fixture does not exist in the store", () => {
