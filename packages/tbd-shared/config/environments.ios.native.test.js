...
describe("environments iOS", () => {
  describe("createEnvironments", () => {
    ...
    describe("mockserver", () => {
      describe("when called with LaunchArguments", () => {
        it("should assign the mockserver url to the mockserver environment variable", () => {
          expect(environments.mockserver.path).toEqual("http://MOCKHOST:MOCKHOSTPORT/");
        });
      });
    ...
    it("should set localhost to 'https://localhost.betfair.com/'", () => {
      expect(environments.localhost.path).toBe("https://localhost.betfair.com/");
    });
