import { createIceHockeyFixtureViewModel } from "./ice-hockey-fixture";
...
describe("createIceHockeyFixtureViewModel", () => {
  describe("getDateInformation", () => {
    describe("when there is no openDate information on the sportevent", () => {
      it("should return date, dateTime and time as undefined", () => {
        ...
        const iceHockeyFixtureViewModel = getIceHockeyFixtureViewModel({
          userDetails: USER_DETAILS,
          sportEvent: { ...SPORT_EVENT, openDate: undefined },
        });

        expect(iceHockeyFixtureViewModel).toEqual(
