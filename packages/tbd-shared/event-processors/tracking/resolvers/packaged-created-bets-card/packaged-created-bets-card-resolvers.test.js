...
} from "./packaged-created-bets-card-resolvers";
...
describe("packagedCreatedBetsCollapseToggleTrackingResolver", () => {
...
describe("packagedCreatedBetsShowMoreTrackingResolver", () => {
  it("should send correct event", () => {
    const sendEventSpy = jest.fn();
